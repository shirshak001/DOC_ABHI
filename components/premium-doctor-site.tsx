  ...
  return (
    <section id="top" className="relative overflow-hidden bg-medical-gradient px-5 pt-32 lg:px-8 dark:bg-slate-950">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-80px)] max-w-7xl items-center gap-12 pb-20 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="relative mx-auto max-w-xl">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute bottom-7 left-7 right-7 rounded-3xl bg-white/78 p-5 shadow-luxury backdrop-blur-xl dark:bg-slate-950/70"
              >
        ...
        >
          <motion.p variants={fadeUp} transition={spring} className="mb-5 inline-flex items-center gap-2 rounded-full border border-brand-blue/15 bg-white/70 px-4 py-2 text-sm font-bold text-brand-blue backdrop-blur dark:bg-white/10">
            <HeartBeatIcon /> Premium patient-first medicine
          </motion.p>
          <motion.h1 variants={fadeUp} transition={spring} className="font-serif text-5xl leading-[1.02] text-brand-ink md:text-7xl lg:text-8xl dark:text-white">
            Dr. Abhijit Biswas
          </motion.h1>
          <motion.p variants={fadeUp} transition={spring} className="mt-6 max-w-2xl font-serif text-3xl leading-tight text-slate-800 md:text-5xl dark:text-slate-100">
            Compassionate Healthcare. Trusted Expertise. Personalized Treatment.
          </motion.p>
          <motion.p variants={fadeUp} transition={spring} className="mt-6 max-w-2xl text-lg leading-8 text-slate-600 dark:text-slate-300">
